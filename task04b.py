...
gains = float(input("Введите выручку фирмы: "))
costs = float(input("Введите издержки фирмы: "))
if costs > gains:
    print("Фирма работает в убыток :(")
else:
    print(f'Фирма работает не в убыток! Прибыль: {gains-costs:.2f} Рентабельность: {(gains-costs)/gains:.2f}')
    personal = int(input("Введите кол-во сотрудников: "))
    print(f'Прибыль в расчете на одного сотрудника: {(gains-costs)/personal:.2f}')
